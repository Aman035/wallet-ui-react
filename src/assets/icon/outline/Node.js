  ...
  return (
    ...
    >
      <Path
        ...
        fill="#000"
      />
      <Circle cx={12} cy={5.5} r={2} stroke="#000" />
      <Circle cx={12} cy={5.5} r={0.75} fill="#000" />
      <Circle cx={18.5} cy={12} r={0.75} fill="#000" />
      <Circle cx={12} cy={18.5} r={2} stroke="#000" />
      <Circle cx={5.5} cy={12} r={2} stroke="#000" />
      <Circle cx={18.5} cy={12} r={2} stroke="#000" />
      <Circle cx={5.5} cy={12} r={0.75} fill="#000" />
      <Circle cx={12} cy={18.5} r={0.75} fill="#000" />
    </Svg>
  );
}
