...
function SvgNode0Connections(props) {
  return (
    <Svg
      width="24"
      height="24"
    ...
    >
      <Path
        ...
        fill="#000"
      />
      <Circle cx={12} cy={5.5} r={1.75} stroke="#000" strokeWidth={1.5} />
      <Circle cx={12} cy={18.5} r={1.75} stroke="#000" strokeWidth={1.5} />
      <Circle cx={5.5} cy={12} r={1.75} stroke="#000" strokeWidth={1.5} />
      <Circle cx={18.5} cy={12} r={1.75} stroke="#000" strokeWidth={1.5} />
    </Svg>
  );
}
