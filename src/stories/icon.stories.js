...
storiesOf("Icons/Mattress", module)
  ...
  .add("Logo Light", () => <MainContent style={{justifyContent : 'center'}}><MatressLogo color="#000"/></MainContent>)
  .add("Logo Dark", () => <MainContent theme="dark" style={{justifyContent : 'center'}}><MatressLogo color="#fff"/></MainContent>)
